...
Describe 'parse_ini'
	...
	It 'parses multi-scope-separator setting'
		...
		When call parse_ini
		The status should be success
		The variable INI_SETTINGS_multi_scope_separator should equal "/"
	End

	It 'populates INI_SCOPE_NAMES array'
		Data
			#|[scopes]
			#|api = src/api/**
			#|ui = src/ui/**
		...
		When call parse_ini
		The status should be success
		The variable INI_SCOPE_NAMES[0] should equal "api"
		The variable INI_SCOPE_NAMES[1] should equal "ui"
	End

	It 'populates INI_TYPE_NAMES array'
		Data
			#|[types]
			#|feat = A new feature
			#|fix = A bug fix
		...
		When call parse_ini
		The status should be success
		The variable INI_TYPE_NAMES[0] should equal "feat"
		The variable INI_TYPE_NAMES[1] should equal "fix"
	End
End
